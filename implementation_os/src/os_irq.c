...
/**Arrangement of callbacks for each system irq */
 ...
 */
static void os_IRQHandler(LPC43XX_IRQn_Type irq) {
...
/*
 *Attach a callback to a given interruption
 */
...
/*
 *Remove a callback to a given interruption that we want
 *to remove of the vector.
 */
